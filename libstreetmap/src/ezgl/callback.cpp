...
gboolean helpbtn_func(GtkWidget *, gpointer data){
    GObject *window;
...
gboolean press_drive_walk(GtkWidget *, gpointer data){
    drawMachine *np;
    auto application = static_cast<ezgl::application *>(data);
    ...
    GtkEntry* text_entry_0 = (GtkEntry *) application->get_object("int1street1");
    // Get the text written in the widget
    std::string intersection_1_street_1 = gtk_entry_get_text(text_entry_0);
    // Update the status bar message
    
    // Get the GtkEntry object
    GtkEntry* text_entry_1 = (GtkEntry *) application->get_object("int1street2");
    // Get the text written in the widget
    std::string intersection_1_street_2 = gtk_entry_get_text(text_entry_1);
    // Update the status bar message
    
    // Get the GtkEntry object
    GtkEntry* text_entry_2 = (GtkEntry *) application->get_object("int2street1");
    // Get the text written in the widget
    std::string intersection_2_street_1 = gtk_entry_get_text(text_entry_2);
    // Update the status bar message
    
    // Get the GtkEntry object
    GtkEntry* text_entry_3 = (GtkEntry *) application->get_object("int2street2");
    // Get the text written in the widget
    std::string intersection_2_street_2 = gtk_entry_get_text(text_entry_3);
    // Update the status bar message
    
    // Get the GtkEntry object
    GtkEntry* walking_speed_entry = (GtkEntry *) application->get_object("walking_speed");
    // Get the text written in the widget
    std::string walking_speed = gtk_entry_get_text(walking_speed_entry);
    // Update the status bar message
    
    double walkingSpeed = stod(walking_speed);
    
    // Get the GtkEntry object
    GtkEntry* walking_time_limit_entry = (GtkEntry *) application->get_object("walking_time_limit");
    // Get the text written in the widget
    std::string walking_time_limit = gtk_entry_get_text(walking_time_limit_entry);
    // Update the status bar message
    
    double walkingTimeLimit = stod(walking_time_limit);
    
    np->pathTextParserPool(intersection_1_street_1, intersection_1_street_2, intersection_2_street_1, intersection_2_street_2, walkingSpeed, walkingTimeLimit);
...
gboolean press_drive_only(GtkWidget *, gpointer data)
{
  ...
  auto canvas = application->get_canvas(main_canvas_id);
    ...
    np->pathTextParser(intersection_1_street_1, intersection_1_street_2, intersection_2_street_1, intersection_2_street_2);
    application->refresh_drawing();
