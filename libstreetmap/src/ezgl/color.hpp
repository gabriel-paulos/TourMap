...
static constexpr color BACKGROUND(0xE8, 0xE8, 0xE8);
static constexpr color BUILDINGS(0xD5, 0xD8, 0xDB);
static constexpr color LIGHT_GREENERY(0xC3, 0xEC, 0xB2);
static constexpr color DARK_GREENERY(0x1E, 0xA3, 0x62);
static constexpr color WATER(0xAA, 0xDA, 0xFF);
static constexpr color SAND(0xFF, 0xF2, 0xAF);
static constexpr color MOTORWAY(0xF6, 0xCF, 0x65);
}
